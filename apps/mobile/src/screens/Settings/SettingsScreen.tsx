  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={[styles.headerBar, { backgroundColor: theme.surface }]}>
        ...
        <Title style={[styles.headerBarTitle, { color: theme.onSurface }]}>Settings</Title>
        <View style={{ width: 40 }} />
      </View>
        ...
        <Card style={[styles.card, { backgroundColor: theme.surface }]}>
          <Card.Content>
            ...
            <View style={styles.aboutInfo}>
              <Text style={[styles.aboutText, { color: theme.onSurface }]}>
                Health Competition App
              </Text>
              <Text style={[styles.aboutVersion, { color: theme.onSurfaceVariant }]}>
                Version 1.0.0
              </Text>
              <Text style={[styles.aboutText, { color: theme.onSurfaceVariant }]}>
